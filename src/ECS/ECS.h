...
// Signature - We use a bitset (1s and 0s) to keep track of which components an entity has
// It also helps keep track of which entities a system is interested in
...
class Entity {
    ...
    public:
        ...
        // Put the class keyword here because the class is not created until further down in the file   
